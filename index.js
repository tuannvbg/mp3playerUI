    ...
    (function(window, undefined) {
        ...
        function addPlaylistLi() {
            for (var index = 0; index < arr.length; index++) {
                ...
                var trackAlbum = arr[index].trackAlbum;
                var trackThumb = arr[index].thumb;
                var trackTime = arr[index].time;
                var count = index + 1;
                var html = "";

                html += '<li class="player_playlist_item" song="' + trackFile + '" cover="' + trackThumb + '" artist="' + trackArtist + '" album="' + trackAlbum + '" data-track="' + count + '">' +
                    '<div class="song_block" title="' + trackArtist + trackAlbum + ' – ' + trackName + '">' +
                    '<p class="title_block">' + trackName + '</p>' +
                    '<p class="artist_block">' + trackArtist + '</p>' +
                    '<p class="album_block">' + trackAlbum + '</p>' +
                    '</div>' +
        ...
        function initAudio(element) {
            ...
            var album = $('.album_block', element).text();
        ...
        function addRandomLi() {
            ...
            for (var index = 0; index < randomArr.length; index++) {
                ...
                trackAlbum = randomArr[index].trackAlbum;
